    ...
    <main>
        ...
        <ul class="box-info">
            <?php foreach ($fav as $v): ?>
                <li>
                    <img src="<?= htmlspecialchars($v["lien_image"]) ?>" alt="image du produit" class='bx'>
                    <span class="text">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($historique as $v): ?>
                                <tr>
                                    <td>
                                        <img src="<?= htmlspecialchars($v["img_link"] ?? 'placeholder.jpg') ?>"
                                            alt="image du produit">
                                        <p><?= htmlspecialchars($v["nom"]) ?></p>
                                    </td>
                                    <td><?= htmlspecialchars($v["prix"]) ?>€ </td>
                                    <td><span class="status completed">Date</span></td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                    </table>
                        ...
                        <?php foreach ($panier as $v): ?>
                            <li class="completed">
                                ...
                                <div class="product-details">
                                    <p class="product-name"><?= htmlspecialchars($v["nom"] ?? 'Nom indisponible') ?></p>

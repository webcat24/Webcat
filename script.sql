  ...
  IF
    ...
    IF
      ...
      IF
        ...
        DROP TABLE
        IF
          EXISTS Associe_aux_tags;
          DROP TABLE
          IF
            EXISTS Appartient_categorie_couleur;
            DROP TABLE
            IF
              EXISTS Peinture;
              DROP TABLE
              IF
                ...
                DROP TABLE
                IF
                  EXISTS Autres_materiaux;
                  DROP TABLE
                  IF
                    EXISTS Materiel;
                    DROP TABLE
                    IF
                      EXISTS Historique_commande;
                      DROP TABLE
                      IF
                        EXISTS Images;
                        DROP TABLE
                        IF
                          ...
                          DROP TABLE
                          IF
                            EXISTS Type_autre_materiel;
                            DROP TABLE
                            IF
                              EXISTS Tags;
                              DROP TABLE
                              IF
                                EXISTS Type_peinture;
                                DROP TABLE
                                IF
                                  EXISTS Categorie_couleur;
                                  DROP TABLE
                                  IF
                                    EXISTS Couleur;
                                    DROP TABLE
                                    IF
                                      ...
                                      CREATE TABLE Tags(Nom_tag VARCHAR(250), PRIMARY KEY(Nom_tag));
                                      ...
                                      CREATE TABLE Palette(Nom_palette VARCHAR(50), PRIMARY KEY(Nom_palette));

                                      CREATE TABLE Images(Lien_image VARCHAR(250), PRIMARY KEY(Lien_image));
